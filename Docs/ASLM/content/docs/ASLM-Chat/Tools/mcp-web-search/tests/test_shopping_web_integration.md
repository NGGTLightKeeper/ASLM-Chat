---
title: "test_shopping_web_integration"
draft: false
---

## Module `test_shopping_web_integration`

`Tools/mcp-web-search/tests/test_shopping_web_integration.py` — ASLM Chat Python module.
