...
urlpatterns = [
    ...
    path("api/deep-research/control/", views.deep_research_control_api, name="deep_research_control_api"),
    path("api/deep-research/export/", views.deep_research_export_api, name="deep_research_export_api"),
