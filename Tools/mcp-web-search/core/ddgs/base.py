...
class BaseSearchEngine(ABC, Generic[T]):
    ...
    category: ClassVar[Literal["text"]]
    provider: ClassVar[str]  # provider family used to avoid redundant engine choices
    ...
    def result_type(self) -> type[T]:
        """Get the web-search result type."""
        return TextResult  # type: ignore[return-value]
