...
TOOLS = [
    ...
    },
    {
        ...
        "name": "Read Page",
        "description": (
            "Fetch one or more URLs and return clean markdown (custom-domain handlers, "
            "anti-bot escalation to the warm browser, PDF extraction, BM25 compression). "
            "Pass a single URL string or a list of URLs."
        ),
        "parameters": {
            "type": "object",
            "properties": {
